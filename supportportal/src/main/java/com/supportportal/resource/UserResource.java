...
@RequestMapping("/supportportal2/user")
...
//    }
   ...
   // @DeleteMapping("/delete/{id}") // Change "username" to "id"
   // @PreAuthorize("hasAnyAuthority('user:delete')")
   // public ResponseEntity<HttpResponse> deleteUser(@PathVariable("id") Long id) throws IOException { // Change parameter to Long or appropriate data type
   //     userService.deleteUser(id); // Call the method to delete user by ID
    //    return response(OK, USER_DELETED_SUCCESSFULLY);
   // }
